// This program is used by Crazy Al's Computer Emporium to calculate the monthly pay of commissioned salespeople.
// Angel Santiago
...
double 
       sales, rate, commission, advance, remainingPay; 
